...
/*
 *This is the program I've written to test the shell. It works by counting up incrementally either for as long as it's 
 *active or for a set amount before the shell terminatest it.
 *
 * To Compile, you must first enter the MyRepl then Lab8 before doing so (See the comment in the shell program for more details).
 *
