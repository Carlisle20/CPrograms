/* 
 * csapp.c - Library of Functions originally for the CSAPP 3rd Edition Book, but I just made it into a general purpose library in this case, as it works well for what I often do with C.
 *
 * Updated 10/2016 reb:
